        ...
        'inViewport.now': function(visible) {
            if (visible) {
                ...
                if (this.screenLocation === 'BOOKEND' && this.screenName === 'READER') {
                    this.triggerAnanlyticsEvent(`LANDED_${this.screenLocation}_${this.screenName}`, 'WGEN006', {
                        'USER_ID': this.getUserDetails.userId
                    });    
                } else {
                    this.triggerAnanlyticsEvent(`VIEWED_${this.screenLocation}_${this.screenName}`, 'WGEN006', {
                        'USER_ID': this.getUserDetails.userId
                    });
                }

<template>
    <div class="card">
        <div class="tags-section">
            <div class="head-title">__("tags_categories") <button class="edit" @click="showTags" v-if="pratilipiData.hasAccessToUpdate"><i class="material-icons">mode_edit</i></button></div>
            <div class="tags">

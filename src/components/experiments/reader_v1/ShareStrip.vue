...
export default {
    ...
    methods: {
        ...
        triggerFbEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKFB_BOOKEND_READER`, 'WGEN005', {
        ...
        triggerGpEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKGP_BOOKEND_READER`, 'WGEN005', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerTwEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKTW_BOOKEND_READER`, 'WGEN005', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerWaEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKWA_BOOKEND_READER`, 'WGEN005', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,

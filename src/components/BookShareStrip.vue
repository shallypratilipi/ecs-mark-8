<template>
    <div class="social-share">
        ...
        <a :href="getTwitterUrl" @click="triggerTwEndShareEvent" class="twitter" target="_blank" rel="noopener" aria-label="twitter">
           <span class="social-icon"><icon name="twitter"></icon></span>
        </a>
        <a :href="getGooglePlusUrl" @click="triggerGpEndShareEvent" class="google" target="_blank" rel="noopener" aria-label="google">
